...
<div class="col-xs-6">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <div class="input-group">
        <select class="form-control" id="clientWorkPlace"  >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
       <div class="input-group">
          <select class="form-control" id="clientWorkSector">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <div class="input-group">
        <select class="form-control" id="clientWorkSection"  > 
            <option value="vacio" placeholder="Seccion"></option>   
        </select>        
        <span class="input-group-btn">
          <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-plus"></span></button>
        </span>         
    ...
    <div class="col-sm-9">
      <div class="input-group">
        <select class="form-control" id="clientWorkDepartment" placeholder="Departamento" >
            <option value="vacio" placeholder="Seccion"></option>   
        </select>       
        <span class="input-group-btn">
          <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-plus"></span></button>
    ...
    <div class="col-sm-9">
      <div class="input-group">
        <select class="form-control" id="clientWorkAppointment" placeholder="Cargo" >
            <option value="vacio" placeholder="Seccion"></option>   
        </select>           
        <span class="input-group-btn">
          <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-plus"></span></button>
    ...
    <div class="col-sm-9">
      <div class="input-group">
        <select class="form-control" id="clientWorkAppointment" placeholder="Cargo" >
            <option value="vacio" placeholder="Ciudad" >
        </select>            
        <span class="input-group-btn">
          <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-plus"></span></button>
        </span>      
    ...
    <div class="col-sm-9">
      <div class="input-group">
         <select class="form-control" id="clientContact" placeholder="Contacto" >
            <option value="vacio" placeholder="Ciudad" >
        </select>           
        <span class="input-group-btn">
          <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-plus"></span></button>
