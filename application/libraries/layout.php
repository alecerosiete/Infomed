...
/**
	 ...
	 * @var sting
	 */	
	public $title       = 'Infomed';	
	public $keywords    = 'Infomed';	
	public $descripcion = 'Infomed';
	...
	function view($view = null, $data = null, $return = false)
	{
		...
		$load_view		= array(
        'headers_for_layout' => $this->element('headers',null,true),
        'menu_for_layout' => $this->element('menu',$data,true),
        'content_for_layout' => $this->CI->load->view($vista, $data, true),                          
        'footer_for_layout' => $this->element('footer',$data,true)
        );
